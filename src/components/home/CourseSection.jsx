      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {courses.length > 0 ? (
          <div className="relative group/carousel">
            ...
            {/* Scroll Shadows */}
            {canScrollPrev && (
               <div className="absolute -left-4 top-0 bottom-0 w-24 bg-gradient-to-r from-white via-white/70 to-transparent z-10 pointer-events-none" />
            )}
            {canScrollNext && (
               <div className="absolute -right-4 top-0 bottom-0 w-24 bg-gradient-to-l from-white via-white/70 to-transparent z-10 pointer-events-none" />
            )}
